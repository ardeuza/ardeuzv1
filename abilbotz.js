...
/* YOUTUBE = ABIL BOTZ
   WHATSAPP = https://wa.me/6281414414403
...
let botname = 'Ardeuz Bot' //NAMA BOT
let lolkey = 'RIFQIBOTZ' //Ganti Pake Api Lu Sendiri Biar Limitnya Gak Cepet Abis , Login Di api.lolhuman.xzy Untuk Mendapatkan Api Gratis
...
const ytabilbotz = "6281414414403@s.whatsapp.net"
...
const kon2 = `${faketeks}`
const kon3 = [{buttonId: `!menu`,buttonText: {displayText: `Menu`,},type: 1,}]
...
const katalog = (teks) => {
res = abilbotz.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 111119999, "message": teks, "footerText": "Ardeuz Bot", "thumbnail": fs.readFileSync('pee.jpg'), "surface": 'CATALOG' }}, {quoted:fstatus})
abilbotz.relayWAMessage(res)}
const fakeyt = (teks) => { 
abilbotz.sendMessage(from, teks, text,{contextInfo :{text: 'hi', "forwardingScore": 1000000000, isForwarded: false, sendEphemeral: false, "externalAdReply": { "title": `hallo ${pushname}🗿` , "body": `Ardeuz Bot`, "mediaType": "2", "thumbnailUrl": "https://c.top4top.io/p_2087f30hj1.jpeg", "mediaUrl": "https://google.com", "thumbnail": fs.readFileSync('pee.jpg'), "sourceUrl": "", },mentionedJid:[sender]}, quoted : fstatus})};
...
const fvn = {key: {participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "120363022680878458@g.us" } : {})},message: { "audioMessage": {"mimetype":"audio/ogg; codecs=opus","seconds":99999,"ptt": "true"}} }
const fstatus = { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "Ardeuz Bot", 'jpegThumbnail': fs.readFileSync('pee.jpg')}}}
...
but = [{ buttonId: `.allmenu`, buttonText: { displayText: 'Open Menu' }, type: 1 }]
...
${symbol} ${prefix}tobc
${symbol} ${prefix}q`
but = [{ buttonId: `.patrick`, buttonText: { displayText: 'Patrick' }, type: 1 }]
sendButLocation(from, lolot, ok, img, but)
break
...
╰────
╭─[ *MINAT CHAT* ]
│❏ wa.me/6281414414403?text=buy+premium
╰────
╭─[ *TES BOT? PC OWNER* ]
│❏  Wa.me/6281414414403
╰────
...
╰────
╭─[ *MINAT CHAT* ]
│❏ wa.me/6281414414403?text=sewa+bot
╰────
╭─[ *TES BOT? PC OWNER* ]
│❏  Wa.me/6281414414403
╰────
...
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fstatus})
 listMsg = {
 buttonText: 'Payment 🏷️',
 footerText: 'Ardeuz Bot',
...
case 'groupbot':
reply(`https://chat.whatsapp.com/LVd3KN09rLjL92QcV6hgDJ`)
break
...
costum(buffer, image, Verived, `JANGAN LUPA SUBREK Ardeuz Bot`)
fs.unlinkSync(ran)
})
break
case 'tomp3':
